<div class="box box-warning">
    <div class="box-header">
        <h3 class="box-title">Data Informasi EM Apps</h3>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form-tambah">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="url_wordpress"
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form-ubah">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="url_wordpress" id="url_wordpress"
                                   placeholder="Url Wordpress ...">
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#data-table').DataTable({
            "ajax": '<?= base_url(); ?>informasi/autoload',
            "columns": [
                {"data": "no"},
                {"data": "category"},
                {"data": "title"},
    ...
    function ubah(id) {
        $('#form-ubah')[0].reset();
        $.ajax({
            url: '<?= base_url(); ?>informasi/getdata',
            type: 'POST',
            dataType: 'json',
            data: 'id=' + id,
            success: function (r) {
